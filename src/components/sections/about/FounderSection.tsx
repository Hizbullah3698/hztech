...
export function FounderSection() {
    return (
        <section className="py-16 lg:py-20 border-b border-white/5 bg-hz-primary">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                    <div className="w-full lg:w-1/3 flex justify-center lg:justify-start">
                        <div className="relative group">
                            ...
                            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-hz-teal/30 p-2">
                    ...
                    <div className="w-full lg:w-2/3">
                        <h2 className="font-sora text-3xl md:text-4xl font-extrabold text-hz-text mb-1">Hizbullah Wazir</h2>
